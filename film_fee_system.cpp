    ...
    do{
      ...
      switch(selection){
		...
		case 'A':{
            ...
            cout << "Enter the type:";
            cin >> type;
            cout << "The tyepe of the film: " << type << endl;
	   ...
	   case 'W':{
            ...
            if (movieNum < 1 || movieNum > sizeof(films)/sizeof(films[0])) {
            	...
            	for(film_count = 0; film_count<movieNum; film_count ++)
            	{          		
            		Film selectedFilm = films[movieNum-1];
               		double monthlyFee = calculateMonthlyFee(selectedFilm);
               		cout << "You've watched film, and type of the film is" << endl;
               		cout << "Film Archive Fee Details:" << endl;
              		cout << "-------------------------------------------------" << endl;
             		cout << "Monthly rent fee: " << selectedFilm.getName()  << monthlyFee << "TL" << endl;
            		cout << "-------------------------------------------------" << endl;
				}
